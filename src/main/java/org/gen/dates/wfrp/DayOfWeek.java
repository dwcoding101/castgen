...
public enum DayOfWeek implements TemporalAccessor, TemporalAdjuster {
     ...
     * <p>
     * The values are numbered following the ISO-8601 standard, from 1 (Wellentag) to 8 (Festag).
     *
     *
     * @return the day-of-week, from 1 (Wellentag) to 8 (Festag)
     */
    public int getValue() {
        return ordinal() + 1;
    }
    ...
    public DayOfWeek plus(long days) {
        int amount = (int) (days % 8);
        return ENUMS[(ordinal() + (amount + 8)) % 8];
    }
